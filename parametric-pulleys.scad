...
// PULLEY IDLER (608 BEARING)
	...
	render_pulley(
		...
		motor_shaft = 22.4,			// NEMA17 motor shaft exact diameter = 5
		...
		pulley_b_ht = 0,				// pulley base height, standard = 8
		pulley_b_dia = -1,			// pulley base diameter, set -1 for maximum diameter
	...
	difference(){
		cylinder(r=22.2/2,h=(7+2*1-bearing_width)/2);
		translate([0,0,-1])
			cylinder(r=22/2-1,h=1+2);
	}
...
//	translate([35,0,0]){
	...
	translate([0,0,9.4+9+9])
		difference(){
			union(){
				cylinder(r=8.4/2+wall,h=y_end_body_width_idler+y_idler_bolt_washer_thickness+bearing_width/2-7/2-1-wall_thin);
				translate([0,0,y_end_body_width_idler+y_idler_bolt_washer_thickness+bearing_width/2-7/2-1-wall_thin])
					cylinder(r1=8.4/2+2*wall_thin,r2=8.4/2+wall_thin,h=wall_thin);
			}
			translate([0,0,-1])
				cylinder(r=8.4/2,h=y_end_body_width+y_end_body_width_idler+y_idler_bolt_washer_thickness+bearing_width/2-wall-bearing_width-7/2-1.5+2);
		}
//	}
...
//	translate([-35,0,0]){
	...
	difference(){
		union(){
			translate([0,0,9+2.6]) mirror([0,0,1]) render_pulley(
				teeth = 18,					// Number of teeth, standard Mendel T5 belt = 8, gives Outside Diameter of 11.88mm
				profile = 6,					// 1=MXL 2=40DP 3=XL 4=H 5=T2.5 6=T5 7=T10 8=AT5 9=HTD_3mm 10=HTD_5mm 11=HTD_8mm 12=GT2_2mm 13=GT2_3mm 14=GT2_5mm
				...
				pulley_t_ht = 7,				// length of toothed part of pulley, standard = 12
				pulley_b_ht = 2.6,				// pulley base height, standard = 8
				pulley_b_dia = -1,			// pulley base diameter, set -1 for maximum diameter
				no_of_nuts = 0,				// number of captive nuts required, standard = 1
				nut_angle = 90,				// angle between nuts, standard = 90
				nut_shaft_distance = 1	// distance between inner face of nut and shaft, can be negative.
		...
		for(j=[0:2])
			rotate([0,0,j*120]){
				translate([0,0,9])
					translate([0,10,0])
						rotate([0,0,0])
							cylinder(r=cornerdiameter(5.9)/2,h=2.6+1,$fn=6);
				translate([0,0,-1])
					translate([0,10,0])
						cylinder(r=3.4/2,h=9+2.5+2);
			}
	}
//	}
			...
			rotate([0,0,k*120])
				for(i=[-15:15])
					rotate([0,0,i])
						translate([0,0,-1])
							translate([0,10,0])
								cylinder(r=3.4/2,h=9.4+2);
	}
//	}



// PULLEY MOTOR Y (NEMA 17)
//	translate([0,-35,0])
//	translate([0,0,9+9.4])
//	mirror([0,0,1])
	render_pulley(
...
//	mirror([0,0,1])
	...
	translate([0,0,3])
		render_pulley(
			...
			pulley_t_ht = 7,				// length of toothed part of pulley, standard = 12
			pulley_b_ht = 3.4,				// pulley base height, standard = 8	//9.4
			pulley_b_dia = -1,			// pulley base diameter, set -1 for maximum diameter
			no_of_nuts = 3,				// number of captive nuts required, standard = 1
			nut_angle = 120,				// angle between nuts, standard = 90
			nut_shaft_distance = 1	// distance between inner face of nut and shaft, can be negative.
	...
	difference(){
		render_pulley(
			...
			pulley_t_ht = 7,				// length of toothed part of pulley, standard = 12
			pulley_b_ht = 9.4,				// pulley base height, standard = 8	//9.4
			pulley_b_dia = -1,			// pulley base diameter, set -1 for maximum diameter
			no_of_nuts = 3,				// number of captive nuts required, standard = 1
			nut_angle = 120,				// angle between nuts, standard = 90
			nut_shaft_distance = 1	// distance between inner face of nut and shaft, can be negative.
		...
		translate([0,0,6.4])
			render_pulley(
				teeth = 18+2,					// Number of teeth, standard Mendel T5 belt = 8, gives Outside Diameter of 11.88mm
				profile = 6,					// 1=MXL 2=40DP 3=XL 4=H 5=T2.5 6=T5 7=T10 8=AT5 9=HTD_3mm 10=HTD_5mm 11=HTD_8mm 12=GT2_2mm 13=GT2_3mm 14=GT2_5mm
				...
				pulley_t_ht = 7,				// length of toothed part of pulley, standard = 12
				pulley_b_ht = 20,				// pulley base height, standard = 8	//9.4
				pulley_b_dia = -1,			// pulley base diameter, set -1 for maximum diameter
				no_of_nuts = 0,				// number of captive nuts required, standard = 1
				nut_angle = 120,				// angle between nuts, standard = 90
				nut_shaft_distance = 1	// distance between inner face of nut and shaft, can be negative.
