...
extruder_idler_hinge_screw_length = 60;
...
controller_touchscreen_width = 263;
controller_touchscreen_height = 179;
controller_touchscreen_cornerradius = 10;
controller_touchscreen_glassthickness = 1;
controller_touchscreen_thickness = 7.5;
controller_touchscreen_glasssideclearance = 9;
