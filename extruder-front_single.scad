...
module extruder_front(){
	difference(){
		...
		union(){
			hull(){
				translate([-extruder_front_body_width/2-(extruder_mount_screw_dia/2+clearance),-extruder_front_body_length,extruder_back_body_height/2-wall])
                    rotate([-90,0,0])
				...
				translate([0,-extruder_front_body_length,extruder_back_body_height/2-extruder_front_body_height+wall])
					rotate([-90,0,0])
						cylinder(r=wall,h=extruder_front_body_length);
				translate([-extruder_front_body_width/2-(extruder_mount_screw_dia/2+clearance),-extruder_front_body_length,extruder_back_body_height/2-extruder_front_body_height+wall])
                    rotate([-90,0,0])
						cylinder(r=wall,h=extruder_front_body_length);
			}
			hull(){
...
//						cylinder(r=wall,h=extruder_front_body_length);
		...
		translate([-extruder_front_body_width/2-(extruder_mount_screw_dia/2+clearance)-wall-1,-wall-clearance,-extruder_front_body_height+extruder_mount_screw_washer_dia+clearance])
			cube([extruder_front_body_width+(extruder_mount_screw_dia/2+clearance)+wall+2,wall+clearance+1,extruder_front_body_height]);
